...
```{r}
barplot(mg, col = c("orange","blue", "pink","green")) # creating a bar chart of mg

barplot(mg,xlim=c(0,2), xlab="Gender", length =levels(mo), col = c("orange","blue", "pink","green")) # creating a bar chart of mg

barplot(mg,xlim=c(0,2), xlab = "Transportation", length =levels(g), col = c("orange","blue", "pink","green")) # creating a bar chart of mg

```

```{r}
barplot(prop.table(mg,1), width=0.25, xlim=c(0,3), ylim=c(0,1), xlab="Gender", legend=levels(mo), beside=T, col = c("orange","green")) # creating a bar chart of mg

mg = table(g,mo) # creating a contingency  of g and mo
barplot(prop.table(mg,2), width=0.25, xlim=c(0,3), ylim=c(0,1), xlab="Transportation", legend=levels(g), beside=T, col= c("orange", "green")) # creating a bar chart of mg
...
```{r}
hist(xo, col = c("orange","lightblue", "pink","lightgreen", "purple", "violet","brown")) # creating a histogram of xo

hist(xo, nclass = 3, col = c("lightblue", "pink","lightgreen")) # creating a histogram of xo
...
```{r}
hist(wo, breaks= seq(from = 1000, to=5000, by=300), col = c("orange","lightblue", "pink","lightgreen")) # creating a histogram of wo

hist(wo, probability=T, col = c("orange","lightblue", "pink","lightgreen")) # creating a histogram of wo
...
```{r}
boxplot(wo, horizontal = T, col = c("orange")) # creating a boxplot of wo

boxplot(wo, vertical = T, col = c("orange")) # creating a boxplot of wo

...
cars %>% model.(dist ~ speed, data = .) %>% head(5)

cars %>% model.(dist ~ speed - 1, data = .) %>% head(5) 
```
...
BreastCancer %>%
 ...
 mutate(IsMalignant = ifelse(Class == "benign", 0, 1)) %>%
 model.(IsMalignant ~ Cl.thickness.numeric + Cell.size.numeric,
 data = .) %>% head() 
```
...
BreastCancer %>%
 ...
 as.numeric(as.character(Cell.size))) %>%
 mutate(IsMalignant = ifelse(Class == "benign", 0, 1)) %>%
 model.(IsMalignant ~ Cl.thickness.numeric + Cell.size.numeric - 1,
 data = .) %>% head() 
```
...
BreastCancer %>%
 mutate(IsMalignant = ifelse(Class == "benign", 0, 1)) %>%
 model.(IsMalignant ~ Bare.nuclei, data = .) %>%
 head() 
```
...
BreastCancer %>%
 mutate(IsMalignant = ifelse(Class == "benign", 0, 1)) %>%
 model.(IsMalignant ~ Cl.thickness, data = .) %>%
 head() 
```
...
BreastCancer %>%
 ...
 as.numeric(as.character(Cell.size))) %>%
 mutate(IsMalignant = ifelse(Class == "benign", 0, 1)) %>%
 model.(IsMalignant ~ Cl.thickness.numeric * Cell.size.numeric, data = .) %>% head() 
```
...
BreastCancer %>%
 ...
 as.numeric(as.character(Cl.thickness))) %>%
 mutate(IsMalignant = ifelse(Class == "benign", 0, 1)) %>%
 model.(IsMalignant ~ Cl.thickness.numeric * Bare.nuclei, data = .) %>% head() 
```
...
```{r poly}
cars %>% model.(dist ~ speed + speed^2, data = .) %>% head 
```

```{r poly.1}
### Polynomial function
cars %>% model.(dist ~ speed + I(speed^2), data = .) %>% head 
...
```{r}
iris %>% model.(Sepal.Width ~ Sepal.Length, data = .) %>% head

iris %>% model.(Sepal.Width ~ Sepal.Length + I(Sepal.Length^2), data=.) %>% head()

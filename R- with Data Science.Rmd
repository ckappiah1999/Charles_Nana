...
(specificity <- confusion_[1,1]/
 (confusion_[1,1] + confusion_[1,2])) # negative class

(sensitivity <- confusion_[2,2]/
 (confusion_[2,1] + confusion_[2,2])) # positive class
```
...
confusion_[2,1] / sum(confusion_[,1])
confusion_[1,1] / sum(confusion_[,1]) 

confusion_[2,2] / sum(confusion_[,2]) 
confusion_[1,2] / sum(confusion_[,2]) 
```
